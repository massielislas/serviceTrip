...
public class StatusServiceIT {
  ...
  public void pingShouldReturnHostNameAndTimestamp() {
    Response response =
        client.target("http://localhost:8080/serviceTrip/api/status/ping").request().get();
    ...
    // If we reach this point without exceptions, the test has passed. No further assertions are
    // necessary.
  }
}
