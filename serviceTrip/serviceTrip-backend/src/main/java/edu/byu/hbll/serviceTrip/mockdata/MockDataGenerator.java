...
public class MockDataGenerator {
    ...
    public MockDataGenerator(){
        ...
        descriptions.add("Rwanda is a country of children with no children's hospital.  Join us to help build the first children's hospital in Rwanda.\n" +
                "\n" +
        ...
        descriptions.add("Charlie Bean is turning 3!  Let’s help to show her that it’s important to make a difference in this world!  \n" +
